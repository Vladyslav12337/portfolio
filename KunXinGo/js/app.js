(() => {
    ...
    function initSliders() {
        ...
        if (document.querySelector(".servies__slider")) resizableSwiper("(max-width: 991.98px)", ".servies__slider", {
            modules: [ Navigation, Grid ],
            navigation: {
                prevEl: ".servies__arrow--prev",
                nextEl: ".servies__arrow--next"
            },
            grid: {
                rows: 2
            },
    ...
    const resizableSwiper = (breakpoint, swiperClass, swiperSettings, callback) => {
        ...
        checker();
        if (document.querySelector(".change__slider")) new swiper_core_Swiper(".change__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: "auto",
            ...
            loop: false,
            navigation: {
                prevEl: ".change__arrow--prev",
                nextEl: ".change__arrow--next"
            },
            on: {}
        });
    };
    ...
    const headerStatickButton = document.querySelector(".header__statick-button");
    menuButton.addEventListener("click", (() => {
        const buttonText = headerStatickButton.querySelector("p");
        if (headerStatickButton.classList.contains("move-to-right")) {
            headerStatickButton.classList.remove("move-to-right");
            buttonText.style.display = "block";
        } else {
            headerStatickButton.classList.add("move-to-right");
